        ...
        <div className="w-80 bg-white shadow-lg border-r border-gray-200 flex-shrink-0 overflow-hidden">
          <div className="h-full flex flex-col justify-between p-3">
            ...
            <div className="flex flex-col gap-6">
              <div className="bg-blue-50 rounded-lg p-4 border border-blue-100 mt-20">
                ...
                <p className="text-blue-800 text-sm leading-relaxed">
                  ...
                  ulaşabilceksiniz. Türkiye'nin en güvenilir ve profesyonel
                  otomotiv hizmet platformu. Kaliteli hizmet veren işletmeleri
                  keşfedin ve güvenle iletişime geçin.
                </p>
              </div>
...
*/}
            ...
            {/* Footer */}
            <div className="text-center text-gray-500 text-xs pt-4 border-t border-gray-200 mt-auto">
