      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-6 mb-6 sm:mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4 sm:mb-6">
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Filtreler</h2>
            <button
              onClick={clearFilters}
              className="group relative overflow-hidden px-3 py-2 sm:px-4 sm:py-2 bg-gradient-to-r from-gray-100 to-gray-200 text-gray-600 hover:text-gray-800 text-sm font-medium rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-md border border-gray-200 w-full sm:w-auto"
            >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
          ...
          {isLoading && (
            <div className="flex items-center justify-center sm:justify-start space-x-2 bg-white px-3 py-2 sm:px-4 sm:py-2 rounded-xl shadow-md">
        ...
        {filteredBusinesses.length === 0 ? (
          <div className="text-center py-8 sm:py-16 bg-white rounded-2xl shadow-xl px-4">
            ...
            <button
              onClick={clearFilters}
              className="group relative overflow-hidden px-4 py-2 sm:px-6 sm:py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all duration-300 transform hover:scale-105 hover:shadow-lg font-medium text-sm sm:text-base"
            >
              <div className="flex items-center gap-2">
                <svg
