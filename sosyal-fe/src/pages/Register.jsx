  ...
  const handlePhotoChange = (e) => {
    ...
    const validFiles = files.filter(file => {
      ...
      if (file.size > 5 * 1024 * 1024) {
        alert(`Dosya ${file.name} çok büyük. Maksimum dosya boyutu 5MB olmalıdır.`);
        return false;
      }
    ...
    if (validFiles.length !== files.length) {
      alert('Bazı dosyalar uygun formatta değil. Sadece 5MB\'dan küçük resim dosyaları yüklenebilir.');
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const userData = {
        ...
        // Add customer preferences if applicable
        ...(userType === 'musteri' && {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Sosyal Platform'a katılın ve hizmetlerden yararlanın</p>
        </div>

        {/* Platform Information Section */}
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Neden Sosyal Platform?</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Türkiye'nin en güvenilir ve profesyonel hizmet platformunda, kaliteli hizmet verenler ile 
              ihtiyaç sahiplerini buluşturuyoruz. Güvenli, hızlı ve memnuniyet garantili hizmet deneyimi.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="text-center p-6 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200">
              ...
              <h3 className="text-lg font-semibold text-blue-900 mb-2">%100 Güvenli</h3>
              <p className="text-blue-800 text-sm">
                SSL şifreleme, güvenli ödeme sistemleri ve kullanıcı doğrulama ile tam koruma
              </p>
            </div>
            ...
            <div className="text-center p-6 bg-gradient-to-br from-green-50 to-green-100 rounded-xl border border-green-200">
              ...
              <h3 className="text-lg font-semibold text-green-900 mb-2">Hızlı & Kolay</h3>
            ...
            <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl border border-purple-200">
              ...
              <h3 className="text-lg font-semibold text-purple-900 mb-2">Müşteri Odaklı</h3>
          ...
          <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-6 border border-gray-200">
            <h3 className="text-xl font-semibold text-gray-900 mb-6 text-center">Platform İstatistikleri</h3>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="text-center">
                <div className="text-3xl font-bold text-blue-600 mb-2">50,000+</div>
                <div className="text-sm text-gray-600 font-medium">Kayıtlı Kullanıcı</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-green-600 mb-2">15,000+</div>
                <div className="text-sm text-gray-600 font-medium">Aktif Hizmet</div>
              </div>
              <div className="text-center">
          ...
          {/* How It Works */}
          <div className="mt-8">
            <h3 className="text-xl font-semibold text-gray-900 mb-6 text-center">Nasıl Çalışır?</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h4 className="font-semibold text-gray-900 mb-2">Hesap Oluşturun</h4>
              ...
              <div className="text-center">
                ...
                <h4 className="font-semibold text-gray-900 mb-2">Hizmet Bulun</h4>
                <p className="text-gray-600 text-sm">
              ...
              <div className="text-center">
                ...
                <h4 className="font-semibold text-gray-900 mb-2">İletişime Geçin</h4>
                <p className="text-gray-600 text-sm">
          ...
          <div className="mt-8 p-6 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl border border-blue-200">
            <div className="flex items-center justify-center space-x-4 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900">Güvenlik & Gizlilik</h3>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
          <h2 className="text-xl font-semibold text-gray-900 mb-4 text-center">Kullanıcı Tipi Seçin</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Müşteri</h3>
            ...
            >
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">İlan Veren</h3>
            ...
            <div className="border-b border-gray-200 pb-6">
              ...
              <div className="max-w-4xl">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500 mb-4">
                          PNG, JPG veya GIF dosyalarını sürükleyip bırakın veya seçin
                        </p>
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-4 p-4 bg-gray-50 rounded-xl">
                      <div className="flex items-center space-x-4">
                        <span className="text-sm text-gray-600">
                          <span className="font-medium">{photos.length}</span> fotoğraf yüklendi
                        </span>
                        <span className="text-xs text-gray-500">
                          Toplam boyut: {(photos.reduce((total, photo) => total + photo.file.size, 0) / 1024 / 1024).toFixed(2)} MB
                        </span>
                      </div>
                ...
                <p className="text-xs text-gray-500 mt-3">
                  * Profil fotoğrafları zorunlu değildir. Daha sonra ekleyebilirsiniz. Maksimum 10 fotoğraf yükleyebilirsiniz.
                </p>
              </div>
            </div>
              ...
              <div className="border-b border-gray-200 pb-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows="3"
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
                    placeholder="Hangi hizmetlerle ilgileniyorsunuz? (örn: spa, masaj, güzellik, fitness...)"
                  />
                </div>
              </div>
            )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <textarea
                      ...
                      rows="2"
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
                      placeholder="Çalışma saatlerinizi belirtin (örn: Pazartesi-Cuma 09:00-18:00)"
                    />
                  </div>
                </div>
              </div>
