    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Hesabınıza giriş yapın ve hizmetlerden yararlanın</p>
        </div>

        {/* Simple Platform Information Section */}
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
          <div className="text-center">
            <h2 className="text-xl font-semibold text-gray-900 mb-3">Sosyal Platform'a Hoş Geldiniz</h2>
            <p className="text-gray-600 mb-4">
              Türkiye'nin en güvenilir hizmet platformunda binlerce profesyonel hizmet veren ile tanışın
            </p>
